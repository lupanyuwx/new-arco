        ...
        <Space direction='vertical' block align='end'>
          ...
          >
            <Typography.Text
              ...
              type='primary'
            >
              <span className='typography-text'>Vant</span>
            </Typography.Text>
            ...
            <Space direction='vertical' block gap={40}>
              ...
              <Flex className='_home-music-card' align='center'>
                <Image
                  ...
                  src='https://up.36992.com/22/53/a3/ff/2ceb9b6095f11f6e4a9c12bbc2e5201b.jpg'
                />
          ...
          <Flex.Item span={12}>
            <Space direction='vertical' gap={40} block>
              ...
              >
                ...
                <Steps activeColor='#f1ae3d' direction='vertical' active={2}>
              ...
              <Cell
                ...
                title='Avatar'
                label='Typefaces used in this branding project.'
                icon={<Image width={44} height={44} src='https://img0.baidu.com/it/u=4244867706,3274422305&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=500' round />}
              />
            </Space>
          </Flex.Item>
        </Flex>
